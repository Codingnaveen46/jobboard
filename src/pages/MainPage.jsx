...
function MainPage() { 
  ...
  const [apiData, setApiData] = useState(demo.data); 
  const [error, setError] = useState(null); 
  
  let que = actualQuery === "" ? "Full Stack Developer" : actualQuery; 
  let loc = actualLocation === "" ? "India" : actualLocation; 

  const API_KEY = "27b2aca817msh21cfc2aea90263cp1e057ejsn8e225a522875"; 
      ...
      {error && ( 
        <div className="bg-primary text-sm rounded text-white font-Poppins max-w-full p-4 mx-4 mb-4 md:p-8 md:mx-8 md:mb-8"> 
          <div> 
            ...
            Note:{" "} 
            <i> 
              Due to exceeding the monthly quota for requests, you cannot make more requests until the end of the month. 
            </i> 
            <b>
        ...
        <section className="p-4 w-full md:w-2/3 md:p-8"> 
          {apiData == null ? ( 
            <div className="flex flex-col justify-center items-center h-full"> 
              <svg 
                aria-hidden="true"
                className="w-12 h-12 mr-2 text-white animate-spin dark:text-gray-300 fill-blue-600 mb-4"
                viewBox="0 0 100 101"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              > 
                <path 
                  d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.
9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                  fill="currentColor"
                />
                <path 
